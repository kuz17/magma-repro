...
if __name__ == "__main__":
    ...
    if action == "SEARCH":
        print("\n✗ Model repeated SEARCH despite being shown actual search results.")
        print("  This suggests it's not using the image to inform its decision —")
        print("  a real limitation for the planner approach.")
    elif action == "CLICK":
        print("\n✓ Model correctly moved past SEARCH when shown real results.")
        print("  Planner approach looks viable — worth continuing.")
    else:
